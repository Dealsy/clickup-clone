...
import { cog, fileInvoice, gauge, tableColumns, alert } from "./svg-paths";
...
function getLinkClassName(pathname: string, href: string): string {
  const baseClassName =
    "flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-primary p-3 text-sm font-medium hover:bg-foreground/10";
  if (pathname === href) {
